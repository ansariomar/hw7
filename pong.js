// Embed <iframe src="https://alpha.editor.p5js.org/embed/B1V6kf9uG"></iframe>
// Fullscreen https://alpha.editor.p5js.org/full/B1V6kf9uG
// Edit https://alpha.editor.p5js.org/omarprograms/sketches/B1V6kf9uG
...
var miss;
function preload(){
bounce = loadSound('assets/kitten.mp3');
miss = loadSound('assets/sadkitten.mp3');
}
...
function draw() {
  ...
  text('Player 1: use "Q" & "A" keys to move paddle up and down\n Player 2: use "Up" & "Down" keys to move paddle up and down down', width/2, 375) 
  ...
  }else{player1.increaseScore = false}
    if (puck.x - puck.r < -10 || puck.x + puck.r > 410){//if puck exceeds the canvas edge on x axis, ball restarts in center and lost kitten sound plays
      puck.x =200, 200;
